...
This guide shows you how to take any search criteria and turn it into an auto-updating playlist inside your DJ software or music app.
...
### 3. Move music between apps
You can use one app as the source for another. For example, if you have a playlist in Plex that you want to use in Rekordbox:
