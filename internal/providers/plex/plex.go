...
func (s *plexTrackService) Add(ctx context.Context, ectx provider.ExecutionContext, tracks []models.Track, target models.ResourceGroup) (int, error) {
	return 0, provider.ErrReadOnly
}
func (s *plexTrackService) Remove(ctx context.Context, ectx provider.ExecutionContext, tracks []models.Track, group models.ResourceGroup) (int, error) {
	return 0, provider.ErrReadOnly
}
func (s *plexTrackService) Move(ctx context.Context, ectx provider.ExecutionContext, tracks []models.Track, from models.ResourceGroup, to models.ResourceGroup) (int, error) {
	return 0, provider.ErrReadOnly
}
...
func (s *plexSystemService) Capabilities() provider.ProviderCapabilities {
	return provider.ProviderCapabilities{}
}
func (s *plexSystemService) Containment() provider.ContainmentPolicy {
...
func (s *plexSystemService) Save(ctx context.Context, ectx provider.ExecutionContext, path string) error {
	return nil
}
...
func (s *plexSystemService) Sync(ctx context.Context, ectx provider.ExecutionContext, tracks []models.Track, targetQuery string, opts provider.SyncOptions) error {
	return provider.ErrReadOnly
}
